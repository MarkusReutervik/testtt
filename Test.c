...
void addStudent()
{   //Går igenom listan lägger till studenter
    for (int i = 0; i < count; i++)
    {   
        printf("Student %d name:\n ", i + 1);

        //används för att läsa in en rad text (en sträng) från en viss inputkälla.
        //funktion(buffertarray[index]strukturfält, funktion(buffertarray[index]struktur), inputström);
       //läsa in en rad text(Mål för lagring i strukt[index].specifikt fält som ska användas, hur många tecken som får läsas in.
